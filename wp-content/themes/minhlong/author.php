...
<div class="content">
    ...
    <section id="main-content">
        <div class="author-box"><?php
            ...
            printf( '<h3>'. __( 'Posts by %1$s', 'minhlong' ) . '</h3>', get_the_author() );

            // Hiển thị giới thiệu của tác giả
            echo '<p>'. get_the_author_meta( 'description' ) . '</p>';

            // Hiển thị field website của tác giả
            if ( get_the_author_meta( 'user_url' ) ) : printf( __('<a href="%1$s" title="Visit to %2$s website">Visit to my website</a>', 'minhlong'),
